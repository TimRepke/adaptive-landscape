import { createScatterplot } from './regl-scatterplot/dist/regl-scatterplot.module.js';
...
const datasetSelectorEl = document.querySelector('#dataset');
...
(async () => {
const dataHandler = await new DataHandler(datasetSelectorEl, datasetLoaded);
dataHandler.onChange();
})();