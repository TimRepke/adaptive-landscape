...
from externals.umap.umap.distances import pairwise_special_metric, SPECIAL_METRICS
from externals.umap.umap.sparse import SPARSE_SPECIAL_METRICS, sparse_named_distances
