...
from externals.thesne.model.core import floath
from externals.thesne.model.core import cost_var
from externals.thesne.model.core import find_sigma
import logging

logger = logging.getLogger('thesne')
...
def dynamic_tsne(Xs, perplexity=30, Ys=None, output_dims=2, n_epochs=1000,
    ...
    if Ys is None:
        ...
        logger.debug(f'Created Ys as it wasn\'t provided with {Ys.shape}')
