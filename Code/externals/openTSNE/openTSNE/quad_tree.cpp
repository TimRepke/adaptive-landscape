...
static int __pyx_pf_8openTSNE_9quad_tree_8QuadTree___init__(struct __pyx_obj_8openTSNE_9quad_tree_QuadTree *__pyx_v_self, __Pyx_memviewslice __pyx_v_data) {
  ...
  int __pyx_t_12;
  __pyx_t_8openTSNE_9quad_tree_Node __pyx_t_13;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
 ...
 */
    __pyx_t_10 = __pyx_v_d;
    __pyx_t_9 = __pyx_v_d;
    __pyx_t_12 = ((((*((double *) ( /* dim=0 */ (__pyx_v_x_max.data + __pyx_t_10 * __pyx_v_x_max.strides[0]) ))) - (*((double *) ( /* dim=0 */ (__pyx_v_x_min.data + __pyx_t_9 * __pyx_v_x_min.strides[0]) )))) > __pyx_v_length) != 0);
    if (__pyx_t_12) {
 ...
 */
      __pyx_t_9 = __pyx_v_d;
      __pyx_t_10 = __pyx_v_d;
      __pyx_v_length = ((*((double *) ( /* dim=0 */ (__pyx_v_x_max.data + __pyx_t_9 * __pyx_v_x_max.strides[0]) ))) - (*((double *) ( /* dim=0 */ (__pyx_v_x_min.data + __pyx_t_10 * __pyx_v_x_min.strides[0]) ))));
 ...
 */
  __pyx_t_10 = 0;
  __pyx_f_8openTSNE_9quad_tree_init_node((&__pyx_v_self->root), __pyx_v_n_dim, (&(*((double *) ( /* dim=0 */ (__pyx_v_center.data + __pyx_t_10 * __pyx_v_center.strides[0]) )))), __pyx_v_length);
