...
from externals.topological_autoencoders.src.callbacks import Callback, SaveReconstructedImages, \
    SaveLatentRepresentation, Progressbar
from externals.topological_autoencoders.src.datasets.splitting import split_validation
from externals.topological_autoencoders.src.evaluation.eval import Multi_Evaluation
from externals.topological_autoencoders.src.evaluation.utils import compute_reconstruction_error, get_space
from externals.topological_autoencoders.src.training import TrainingLoop
from externals.topological_autoencoders.src.visualization import plot_losses, visualize_latents, shape_is_image, \
