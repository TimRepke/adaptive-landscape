...
from externals.topological_autoencoders.src.datasets import CIFAR
from externals.topological_autoencoders.src.datasets import FashionMNIST
from externals.topological_autoencoders.src.datasets import MNIST
from externals.topological_autoencoders.src.datasets import Spheres
